...
once. The following is a function that will find all the anagrams of a word from a list, given two inputs a word and an array with words, return an array of all the anagrams or an empty array if there are none//return words.
